  ...
  <Row>
      ...
      <Card class='cf'>
       ...
       <span @click='historys' class='spanLeft'> <Icon type="ios-arrow-left"></Icon> 返回</span>
        ...
        <Form :model="data" :label-width="75">
           <Card class="Cardtop">
            <p slot="title">基本信息</p>
            <Row>
            ...
            成交楼盘信息
             ...
             <Row v-show='data.Radios'>
              ...
              <Col :xs="24" :sm="24" :md="8" :lg="5">
               ...
               <Modal v-model="modalyes" width="360" :styles="{top: '5px'}">
             ...
             <Row v-show='!data.Radios'>
                <Col :xs="24" :sm="24" :md="8" :lg="5">
                 ...
                 <FormItem label="工位" class="ivu-form-item-required">
                    <Select v-model="data.Station" filterable>
             ...
             <Row>
              <Col :xs="24" :sm="24" :md="10" :lg="11">
               ...
               <FormItem label="回扣情况">               
                    ...
                    <Col style='padding: 2px 2px 2px 0;' :xs="10" :sm="10" :md="10" :lg="10" class="reds">
                      <Input v-model="data.introduce.vlu_5" readonly>
                         <span slot="append">%</span>
                       </Input>
                    </Col>
                    <Col style='display: none' :xs="10" :sm="10" :md="10" :lg="10">
             ...
             <hr />
              ...
              <Col :xs="24" :sm="24" :md="10" :lg="11">
               ...
               <FormItem label="回扣情况">               
                    ...
                    <Col style='padding: 2px 2px 2px 0;' :xs="10" :sm="10" :md="8" :lg="4" class="reds">
           ...
           <Card class="Cardtop">
            <p slot="title">成交楼盘信息</p>
             ...
             <Row>
                <Col :xs="24" :sm="24" :md="24" :lg="24">
                  <FormItem label="业务合作人">
                     <select v-model="data.cooperation.cooperationn" class="selectUI">
             ...
             <Row v-for="(item, index) in data.cooperation.add" :key="item.length">
                <Col :xs="24" :sm="24" :md="24" :lg="24">
                  <FormItem label="业务合作人">
                     <select v-model="item.cooperationn" class="selectUI">
                        <option v-for="item in cityList" :value="item.value" :key="item.value">{{ item.label }}</option>
                    </select>
                  </FormItem>
                </Col>
               ...
               <Row>
                <Col :xs="24" :sm="24" :md="24" :lg="24">
                  <FormItem label="房源归属人">
                     <select v-model="data.ascription" class="selectUI">
                        <option v-for="item in cityList" :value="item.value" :key="item.value">{{ item.label }}</option>
                    </select>
                  </FormItem>
                </Col>
              ...
              <Row>
                <Col :xs="24" :sm="24" :md="24" :lg="24">
                  <FormItem label="照片归属人">
                     <select v-model="data.imgs" class="selectUI">
                        <option v-for="item in cityList" :value="item.value" :key="item.value">{{ item.label }}</option>
                    </select>
                  </FormItem>
                </Col>
