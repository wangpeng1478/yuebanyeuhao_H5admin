...
<template>
   ...
   <pre>{{dataimg2}}</pre>
   <div v-if="lodasda">
        <Form :model="sharedadds" :label-width="78">
         <Row>
            ...
            <Card style="max-height:782px;min-height:200px;overflow:auto">
              <p slot="title">
                     ...
                     <!-- @click.prevent="changeLimit" -->
                      <a v-if="adminTrue" href="#" @click.prevent="changeLimit3(n.uniqidof)">click</a>
                       <Tooltip content="删除" placement="top">
                            <Button @click.prevent="changeLimit(n.id)" size="small" type="error">删除</Button>
                        </Tooltip>
                ...
                <Card class="Cardsr" v-for="(n, index) in sharedadds.addprivates" :key="n.length" v-if="n.id !==0">
                 ...
                 <Modal v-model="modal2" :closable="false" :mask-closable="false" :styles="{top: '5px'}">
                  <p slot="header">
            ...
            <p slot="title">
               ...
               <Row>
                <Col>
                   <FormItem label="品牌名称"  class="ivu-form-item-required">
                       <Input v-model="sharedadds.sharedaname"></Input>
                  </FormItem>
                </Col>
              </Row>
              <Row>
                         ...
                         <Card>
                            <p slot="title">
                               <Checkbox
                                ...
                                :value="checkAll1"
                                @click.prevent.native="handleCheckAll1">全选</Checkbox> 基础服务
                            </p>
              ...
              <Row>
                         ...
                         <Card style="margin:5px 0">
                            <p slot="title">
                               <Checkbox
                                ...
                                :value="checkAll12"
                                @click.prevent.native="handleCheckAll12">全选</Checkbox> 企业服务
                            </p>
               ...
               <Row>
                <Col>
                   <FormItem label="品牌总机">
                      <Input v-model="sharedadds.switchboard"></Input>
                  </FormItem>
                </Col>
              </Row>
              <Row>
                <Col>
                   <FormItem label="运营公司">
                      <Input v-model="sharedadds.thecompany"></Input>
                  </FormItem>
                </Col>
              </Row>
              <Row>
                <Col>
                   <FormItem label="品牌简介"  class="ivu-form-item-required">
                      <Input v-model="sharedadds.note" type="textarea" :rows="4"></Input>
                  </FormItem>
                </Col>
              </Row>
               </Card>
