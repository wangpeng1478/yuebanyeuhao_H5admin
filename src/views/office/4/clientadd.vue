...
<template>
   <div class="clientadd cf">
    <pre>{{clientadd}}</pre>
   <Form :model="clientadd" :label-width="75">
   <!-- <h2><Icon type="ios-film-outline"></Icon>基本信息</h2> -->
    <div style="margin-bottom:10px;background:#fff;padding:0 5px 0 0">
        <Row>
          <Col style="margin:0 0 5px 0" :xs="24" :sm="24" :md="24" :lg="24" v-for="(n, index) in clientadd.contact" :key="n.length">
             <Card>
                <p slot="title">
                ...
                <a v-else href="#" slot="extra" @click.prevent="removeCliadd(index)" style="color: #ed3f14;">
                 ...
                 <!-- add -->
                  <FormItem label="客户身份"  class="ivu-form-item-required">
                       <select v-model="n.Identity" class="selectUI">
        ...
        <Row>
          ...
          <Col :xs="24" :sm="24" :md="8" :lg="6">
             <FormItem label="公司规模">
                  <select v-model="clientadd.scalex" class="selectUI">
          ...
          <Col :xs="24" :sm="24" :md="8" :lg="6">
             <FormItem label="客户行业">
                 <select v-model="clientadd.tradex" class="selectUI">
