...
<template>
   <div class="clientaddedit cf">
    <pre>{{clientadd}}</pre>
    <div v-if="!jiazaise">
   <Form :model="clientadd" :label-width="75" style="background:#fff">
    <div class="titleNav">
        <p class="rtitle">
            <Icon type="ios-film-outline"></Icon>
            基本信息
        </p>
        <a href="#" class="rextra" @click.prevent="Edits">
              <Icon type="chatboxes"></Icon>
                  跟进
        </a>
    </div>
        <Row>
          <Col style="margin:0 0 5px 0" :xs="24" :sm="24" :md="12" :lg="12" v-for="(n, index) in clientadd.contact" :key="n.length">
             <Card>
                <p slot="title">
                ...
                <a v-else href="#" slot="extra" @click.prevent="removeCliadd(index)" style="color: #ed3f14;">
                 ...
                 <!-- add -->
                  <FormItem label="客户身份"  class="ivu-form-item-required">
                       <select class="selectUI" v-model="n.Identity">
        ...
        <Row>
          <Col :xs="24" :sm="24" :md="12" :lg="8" style="display: none;">
        ...
        <Row>
          ...
          <Col :xs="24" :sm="24" :md="8" :lg="6">
             <FormItem label="公司规模">
                  <select class="selectUI" v-model="clientadd.scalex">
          ...
          <Col :xs="24" :sm="24" :md="8" :lg="6">
             <FormItem label="客户行业">
                 <select class="selectUI" v-model="clientadd.tradex">
        ...
        <Row>
           <Col :xs="24" :sm="24" :md="12" :lg="15">
             <FormItem label="原地址">
                <select class="selectUI" style="width:30%;display:inline-block;margin:2px; 2px 0 0" v-model="clientadd.OriginalAddress" placeholder="请选择城区">
       ...
       <Row>
          <Col :xs="24" :sm="24" :md="24" :lg="24">
           <FormItem label="备注">
               ...
               <Input v-model="clientadd.remarksx" type="textarea" :autosize="{minRows: 4,maxRows: 5}" placeholder="房屋详细信息，小区情况，周边配套，交通情况，对租客要求 ，入住时间"></Input>
           </FormItem>
           </Col>
       </Row>
    </Card>
