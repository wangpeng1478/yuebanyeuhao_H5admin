      ...
      <div v-else>加载中...</div>
        ...
        <Panel name="2">
            ...
            <Card class="mingCard mingCards" v-for="(n, index) in Morelistings" :key="n.length">
               ...
               <p style="font-size:12px"><Icon type="grid"></Icon>  楼盘名称: {{n.name}}</p>
               <p style="font-size:12px"><Icon type="ios-home"></Icon>  门牌号: {{n.men}}</p>
            </Card>
             ...
             <Card style="margin-bottom: 10px;padding-bottom:100px;">
                <p slot="title">
                 ...
                 <Form ref="followUp" :model="followUp" :label-width="80" :rules="ruleInline">
                      ...
                      <FormItem>
                             <Tag type="dot" :color="imgyesNOs?'#F44336':'#999'">房源:{{imgyesNOs?'有图':'无图'}}</Tag>
                             <Tag type="dot" :color="imgyesNO?'#F44336':'#999'">楼盘:{{imgyesNO?'有图':'无图'}}</Tag>
                      </FormItem>

                       <FormItem label="跟进内容" prop="con">
                           <Input v-model="followUp.con" type="textarea" :autosize="{minRows: 3,maxRows: 5}"></Input>
                      </FormItem>
