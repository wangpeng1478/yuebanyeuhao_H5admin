...
<template>
   <div class="add">
    ...
    <li class="color6">
     ...
     <div class="cf" style="padding: 5px;">
     <div>
     <Tooltip content="点击切换数字和字母" placement="top">
             <i-switch size="small" v-model="switch1"></i-switch>
             <span>{{switch1?"数字":"字母"}}</span>
        </Tooltip>
        <Tooltip content="添加高度" placement="top">
            <Button size="small" :disabled="addNubut" type="error" icon="arrow-up-c" @click="adds+=1"></Button>
        </Tooltip>
         <Tooltip content="减少高度" placement="top">
           <Button size="small" :disabled="remNubut" type="error" icon="arrow-down-c" @click="adds-=1"></Button>
        </Tooltip>
        <Tooltip content="添加单元号" placement="top">
            <Button size="small" :disabled="addNubut" type="primary" icon="plus-round" @click="add+=1"></Button>
        </Tooltip>
         <Tooltip content="减少单元号" placement="top">
           <Button size="small" :disabled="remNubut" type="primary" icon="minus-round" @click="add-=1"></Button>
        </Tooltip>
      </div>
