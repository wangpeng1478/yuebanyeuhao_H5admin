...
<Col :xs="24" :sm="24" :md="12" :lg="12">
  <div class="title_botton">基本信息</div>
        ...
        <Row>
           <Col :xs="24" :sm="24" :md="24" :lg="24">
             <FormItem label="类型">
                  <select class="selectUI" v-model="moldx.types" @on-change="typechang">
          ...
          <Col v-if="typessshohide" :xs="24" :sm="24" :md="24" :lg="24">
             <FormItem label="身份">
                  <select class="selectUI" v-model="moldx.moldx2">
  ...
  <div class="title_botton">公司信息</div>
       ...
       <div class="title_botton">其他信息</div>
         ...
         <Row>
            <Col :xs="24" :sm="24" :md="24" :lg="24">
               <FormItem label="社交网络">
                 <select class="selectUI quhao" v-model="moldx.socials.l">
          ...
          <Row v-for="(item, index) in moldx.socials.add" :key="item.length">
            <Col :xs="24" :sm="24" :md="24" :lg="24">
               <FormItem label="社交网络">
                 <select class="selectUI quhao" v-model="item.l">
                      <option value="微信">微信</option>
                      <option value="QQ">QQ</option>
                      <option value="新浪微博">新浪微博</option>
                  </select>
