...
<template>
   ...
   <pre>{{loupnAdd}}</pre>
  <Form :model="loupnAdd" :label-width="90">
     <Card>
       <p slot="title">基本信息</p>
         <Row>
            <Col class="addName">
 ...
 -->
        ...
        <Row v-if="loupnAdd.addnamd.length !==0">
        <FormItem label="">
          <Col style="margin:5px 0" v-for="(item, index) in loupnAdd.addnamd" :key="item.length">
         ...
         <Row>
            <Col class="melese">
               <FormItem label="详细地址" class="ivu-form-item-required">
                     <select class="selectUI" v-model="loupnAdd.region" @on-change="regionDta">
             ...
             <Col>
             <FormItem>
                <select class="selectUI" v-model="loupnAdd.subrange">
        ...
        <Row>
           <Col class="melese">
               <FormItem label="最近地铁" class="ivu-form-item-required">
                    ...
                    <select class="selectUI" v-model="loupnAdd.station" @on-change="stations">
