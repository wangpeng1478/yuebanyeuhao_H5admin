...
<div class="buildinglook">
 ...
 <pre>{{dataimg}}</pre>
  ...
  <h3 class="h3s">{{loupnAdd.name}}基本信息</h3>
          <table class="tables">
            <tbody>
              <tr>
                <th>写字楼名称</th>
        ...
        <!-- ////////////// -->
     <h3 class="h3s">{{loupnAdd.name}}详细信息</h3>
           <table class="tables">
            <tbody>
             ...
             <tr>
              ...
              <tr>
                ...
                <td>{{loupnAdd.enter}}</td>
                  ...
                  <!-- ////////////// -->
        <h3 class="h3s">{{loupnAdd.name}}联系人</h3>
    ...
    <div>
        <Modal v-model="clickCards" :styles="{top: '5px'}">
            <img :src="clickCardsimg" style="width:100%;">
        </Modal>
        <Modal v-model="loocModel" title="填写理由" :styles="{top: '5px'}">
        ...
        <!-- ////////////// -->
    <h3 class="h3s">{{loupnAdd.name}}图片</h3>
