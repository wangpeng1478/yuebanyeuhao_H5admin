    ...
    <div class="login" @keydown.enter="handleSubmit">
       <div class="topbg">
                    ...
                    <Modal v-model="modals" :mask-closable="false" width="650">
                        ...
                        <div class="modalss">
                            ...
                            <ul>
                                ...
                                <li>如果您使用的是360浏览器 请点击地址栏的内核切换按钮 切换到<b>极速模式</b></li>
        ...
        <Modal v-model="timese" :closable='false' :mask-closable='false'>
            <h3 slot="header">警告 现在时间{{time}}</h3>
            <Alert type="warning" show-icon>下班时间无法使用 验证后可以使用</Alert>
            <p @click="timese = false">no</p>
              <!-- <Form ref="formInline">
                 <FormItem>
                    <Input placeholder="验证码" v-model="check">
                        <Icon type="code" slot="prepend"></Icon>
                    </Input>
                </FormItem>
                <FormItem>
                    <Button type="ghost" @click="getticheck">{{gettingI}}</Button>
                </FormItem>
              </Form> -->
